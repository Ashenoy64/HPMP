...
export const SearchRequest = async (name,token) => {
...
export const SetRecentlyPlayed = async (token,details) => {
    try {
...
export const GetPlaylistInfo = async (playlistID,token) => {
    try {
...
export const FollowPlaylist = async (userID, playlistID,token) => {
    try {
