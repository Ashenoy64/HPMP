        ...
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="bg-gray-800 text-white p-6 rounded-lg max-w-3xl z-10 relative">
            ...
            <div className="flex flex-row justify-center w-full">
                    <input type="text" name="" id="" placeholder="Playlist Name" className="w-56 rounded-lg p-2 text-black"/>
            </div>
                <button onClick={onClose} className="text-blue-500 hover:underline cursor-pointer rounded-md">
                Close
              </button>
            </div>
          </div>
