...
export default function Search() {
    ...
    const [results,setResults]=useState([[{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"},{name:"Avanish"},{name:"Monish"}]])
        ...
        <div className="flex flex-col w-full h-full">
            <div className="flex flex-col justify-center text-white gap-4 h-full">
                <div className="bg-slate-100 mx-auto flex flex-row outline-10 w-1/2 md:w-3/4 lg:w-1/4 h-8 rounded-lg overflow-hidden items-center">
                    <input   onChange={onChange} onFocus={onFocus} value={query} ref={searchRef} type="text" name="name"  className="text-black bg-slate-100 w-full p-3 outline-0 " placeholder="Search"/>
                    <button type="submit" className="w-8">
                        <img src="/search.png" alt="" className="bg-slate-100  w-8 p-2" />
                    </button>
                </div>
            
                <div className={`grid grid-cols-0  grid-flow-row md:grid-cols-3 lg:grid-cols-4 mx-auto md:w-11/12  gap-2  overflow-y-auto no-scrollbar ${active ? 'h-full' : 'h-1/2'}`}>
