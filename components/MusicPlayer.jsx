    ...
    return (
      <div className="fixed bottom-0 left-0 right-0 p-4 bg-emerald-600 text-white w-full">
        <div className="flex flex-row justify-between">
          ...
          <div className="w-2/4"><MusicController ref={this.musicController}/></div>
          ...
          <div className="flex flex-row my-auto" >
              ...
              <input type="range" className="hidden sm:block" min="0" max="1" step="0.01"  onChange={(e)=>{this.musicController.current.handleVolume(e)}} id="" />
          </div>
          </div>
        </div>
      </div>
